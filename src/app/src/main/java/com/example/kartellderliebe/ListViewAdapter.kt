...
public class ListViewAdapter(
    val context: Context?,
    private val lstGroups: List<String>,
    private val lstItemsGroups: HashMap<String, List<Investment>>
    ...
    override fun getGroupView(
        ...
        tvAmount.text = java.lang.String.valueOf("TEst")
        return convertView
    }
    ...
    override fun getChildView(
        ...
        val investment: Investment = getChild(groupPosition, childPosition) as Investment
